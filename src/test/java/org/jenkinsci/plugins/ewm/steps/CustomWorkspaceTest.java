...
public class CustomWorkspaceTest {
    ...
    private void verifyWorkspacePath(WorkflowRun run, String pathName, String... pathNames) throws Exception {
        String computedCustomPath = Paths.get(pathName, pathNames).toString();
        ...
        j.assertLogContains(format("Running in %s", Paths.get(tmpFolder.getAbsolutePath(), computedCustomPath)), run);
